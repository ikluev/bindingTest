...
@ObjCClassBinding
public class MOPUBNativeVideoAdRendererSettings extends NSObject implements
	...
	@Generated
	protected MOPUBNativeVideoAdRendererSettings(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native MOPUBNativeVideoAdRendererSettings alloc();

	@Generated
	@Selector("init")
	public native MOPUBNativeVideoAdRendererSettings init();
