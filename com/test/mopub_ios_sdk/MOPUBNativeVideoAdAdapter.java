...
import com.test.mopub_ios_sdk.protocol.MPNativeAdAdapter;
import com.test.mopub_ios_sdk.protocol.MPNativeAdAdapterDelegate;
import ios.NSObject;
...
@ObjCClassBinding
public class MOPUBNativeVideoAdAdapter extends NSObject implements
		MPNativeAdAdapter {
	static {
		NatJ.register();
	}
	...
	@Generated
	protected MOPUBNativeVideoAdAdapter(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native MOPUBNativeVideoAdAdapter alloc();
	...
	@Generated
	@Selector("handleVideoViewClick")
	public native void handleVideoViewClick();

	@Generated
	@Selector("handleVideoViewImpression")
	public native void handleVideoViewImpression();
	...
	@Generated
	@Selector("init")
	public native MOPUBNativeVideoAdAdapter init();

	@Generated
	@Selector("initWithAdProperties:")
	public native MOPUBNativeVideoAdAdapter initWithAdProperties(
